...
_SYSTEM = (
    ...
    "(str), evidence (dict of the distinguishing features -> cluster mean, only "
    "features that deviate notably from the global mean), profile_attributes "
    "(dict), recommended_actions (list of str). "
    ...
    "risk). PRINT the formula you use for "
