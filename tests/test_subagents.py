...
from atria.core.agents.subagents import (
    SubAgentSpec,
    SubAgentManager,
...
class TestSubAgentManager:
    ...
    @patch("atria.core.agents.MainAgent")
...
class TestToolRegistryIntegration:
    ...
    def skip_if_lsp_unavailable(self):
        ...
        try:
            from atria.core.context_engineering.tools.registry import ToolRegistry  # noqa: F401
...
def _can_import_agent_factory():
    ...
    try:
        from atria.core.base.factories.agent_factory import AgentFactory  # noqa: F401
...
class TestAgentFactoryIntegration:
    ...
    @patch("atria.core.base.factories.agent_factory.MainAgent")
    @patch("atria.core.base.factories.agent_factory.SubAgentManager")
    def test_agent_factory_creates_subagent_manager(
        ...
        from atria.core.base.factories.agent_factory import AgentFactory
