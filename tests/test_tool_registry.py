...
def mock_dependencies():
    ...
    mock_modules = {
        "atria.core.runtime": MagicMock(),
        "atria.core.context_engineering.tools.context": MagicMock(),
        ...
        "atria.core.agents.subagents.manager": MagicMock(),
    }
    ...
    mock_modules["atria.core.runtime"].OperationMode = OperationMode
...
def tool_registry_cls(mock_dependencies):
    ...
    if "atria.core.context_engineering.tools.registry" in sys.modules:
        del sys.modules["atria.core.context_engineering.tools.registry"]

    import atria.core.context_engineering.tools.registry as tr
...
def test_plan_mode_blocking(registry, tool_registry_cls, mock_dependencies):
    ...
    mock_runtime = mock_dependencies["atria.core.runtime"]
