...
from atria.repl.file_content_injector import FileContentInjector, InjectionResult
...
class TestImageProcessing:
    ...
    def test_image_with_vision_model(self, temp_workspace):
        ...
        with patch(
            "atria.core.context_engineering.tools.implementations.vlm_tool.VLMTool"
        ) as mock_vlm_class:
            mock_vlm = MagicMock()
...
class TestPDFProcessing:
    ...
    def test_pdf_extraction(self, temp_workspace):
        ...
        with patch(
            "atria.core.context_engineering.tools.implementations.pdf_tool.PDFTool"
        ) as mock_pdf_class:
            mock_pdf = MagicMock()
