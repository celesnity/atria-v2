...
:func:`atria.core.agents.components.schemas.disabled_tools.load_disabled_tools`),
...
from atria.core.agents.components.schemas.disabled_tools import (
...
async def update_disabled_tools(update: DisabledToolsUpdate) -> Dict[str, Any]:
    ...
    keys in ``~/.atria/settings.json`` are preserved. Takes effect on the next
