...
maps_router.py): ``facade_guard`` (atria/web/facade/common.py) wraps the
...
from atria.web.facade.common import facade_guard, request_id
...
# shared 503 service_unavailable envelope from atria.web.facade.common instead
