...
from atria.core.runtime import (
    ConfigManager,
    ModeManager,
)
from atria.core.context_engineering.history import SessionManager, UndoManager
from atria.core.runtime.monitoring import ErrorHandler
...
from atria.ui_textual.components.console_animations import Spinner
from atria.ui_textual.components import StatusLine, NotificationCenter
from atria.ui_textual.autocomplete import SwecliCompleter
from atria.ui_textual.formatters_internal.output_formatter import OutputFormatter
from atria.ui_textual.style_tokens import (
    CYAN,
    ERROR,
    GREY,
    PT_BG_BLACK,
...
# Command handlers
from atria.repl.commands import (
    SessionCommands,
    ModeCommands,
    MCPCommands,
    HelpCommand,
...
class REPL:
    ...
    def _init_tools(self):
        ...
        from atria.core.context_engineering.tools.background_task_manager import (
    ...
    def start(self, *, startup_type: str = "startup") -> None:
        ...
        # Project instructions (ATRIA.md) are now included in the system prompt
    ...
    def _print_welcome(self) -> None:
        ...
        from atria.ui_textual.components import WelcomeMessage
