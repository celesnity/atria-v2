"""Long-term memory and learning for Atria (ACE Pattern).
...
from atria.core.context_engineering.memory.playbook import Playbook, Bullet
from atria.core.context_engineering.memory.delta import DeltaOperation, DeltaBatch
from atria.core.context_engineering.memory.roles import (
    AgentResponse,
    Reflector,
    Curator,
    ReflectorOutput,
