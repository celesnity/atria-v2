...
from atria.core.base.factories import AgentFactory, AgentSuite, ToolDependencies, ToolFactory
from atria.core.base.interfaces import ConfigManagerInterface, ToolRegistryInterface
...
class RuntimeService:
    ...
    def build_suite(
        ...
        *,
        ...
        from atria.core.agents.components.prompts.environment import EnvironmentCollector
