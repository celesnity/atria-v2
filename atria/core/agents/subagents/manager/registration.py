...
if TYPE_CHECKING:
    from atria.core.agents.subagents.manager.manager import AgentConfig
...
class RegistrationMixin:
    ...
    def get_agent_configs(self) -> list[AgentConfig]:
        ...
        """
        from atria.core.agents.subagents.agents import ALL_SUBAGENTS
        from atria.core.agents.subagents.manager.manager import AgentConfig, AgentSource
    ...
    def register_custom_agents(self, custom_agents: list[dict]) -> None:
        ...
        - ~/.atria/agents.json or <project>/.atria/agents.json (JSON format)
        - ~/.atria/agents/*.md or <project>/.atria/agents/*.md (Claude Code markdown format)
