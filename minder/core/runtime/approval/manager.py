"""Interactive approval workflows for Minder."""
...
from minder.models.operation import Operation
...
class ApprovalManager:
    ...
    def _show_interactive_menu(
        ...
        from minder.core.agents.display.style_tokens import PT_META_GREY
        ...
        if command and working_dir:
            ...
            options = [
                ...
                ("3", "No, and tell Minder what to do differently", "esc"),
            ]
        else:
            options = [
                ("1", "Yes"),
