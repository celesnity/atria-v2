...
(minder.core.tasks.broker.broker). Importing minder.core.tasks.tasks here ensures
...
from minder.core.tasks import tasks as _tasks  # noqa: F401 — registers the task on the broker
from minder.core.tasks.broker import broker
from minder.core.tasks.client import TaskIQClient
