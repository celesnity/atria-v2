...
from minder.core.plugins.manager.bundle import BundleMixin
from minder.core.plugins.manager.installer import InstallerMixin
from minder.core.plugins.manager.marketplace import MarketplaceMixin
from minder.core.plugins.models import PluginMetadata
...
class PluginManager(MarketplaceMixin, InstallerMixin, BundleMixin):
    ...
    def _load_plugin_metadata(self, plugin_dir: Path) -> Optional[PluginMetadata]:
        ...
        1. .minder/plugin.json (consistent with app)
