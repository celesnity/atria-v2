...
from minder.core.plugins.config import (
    load_known_marketplaces,
    save_known_marketplaces,
)
from minder.core.plugins.models import (
    MarketplaceInfo,
    PluginMetadata,
)
...
class MarketplaceMixin:
    ...
    def add_marketplace(
        ...
        """
        from minder.core.plugins.manager.manager import PluginManagerError
        ...
        if not self._validate_marketplace(target_dir):
            ...
            raise PluginManagerError(
                ...
                "Expected one of: .minder/marketplace.json, marketplace.json"
            )
    ...
    def remove_marketplace(self, name: str) -> None:
        ...
        """
        from minder.core.plugins.manager.manager import MarketplaceNotFoundError
    ...
    def sync_marketplace(self, name: str) -> None:
        ...
        """
        from minder.core.plugins.manager.manager import MarketplaceNotFoundError, PluginManagerError
    ...
    def _validate_marketplace(self, directory: Path) -> bool:
        ...
        1. .minder/marketplace.json (consistent with app)
        ...
        possible_paths = [
            directory / ".minder" / "marketplace.json",
