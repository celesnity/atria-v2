...
from minder.core.blackboard.admission import admit_notes
from minder.core.blackboard.models import Note
from minder.core.blackboard.render import render_digest
from minder.core.blackboard.verifier import verify_notes
...
class Blackboard:
    ...
    def __init__(
        ...
        *,
        ...
        self._task_id = getattr(store, "_key", "minder:bb:?").removeprefix("minder:bb:")
...
class BlackboardHandle:
    ...
    loop (same shape as ``minder.core.tasks.client.TaskIQClient``) so those sync
