...
class DockerDeployment:
    ...
    def __init__(
        ...
        self._container_name = f"minder-runtime-{uuid.uuid4().hex[:8]}"
    ...
    async def _start_container(self) -> None:
        ...
        env_vars = {
            "MINDER_AUTH_TOKEN": self._auth_token,
            "MINDER_PORT": str(self.config.server_port),
...
AUTH_TOKEN = os.environ.get("MINDER_AUTH_TOKEN")
PORT = int(os.environ.get("MINDER_PORT", "8000"))
