...
if TYPE_CHECKING:
    from minder.models.message import ToolCall
...
class ToolExecutor:
    ...
    def execute_tool_call(
        ...
        from minder.core.agents.display.task_progress import TaskProgressDisplay
        from minder.core.agents.display.tool_display import format_tool_call
