...
from minder.core.utils.sound import play_finish_sound
from minder.core.agents.execution.react_executor.thinking import ThinkingMixin
from minder.core.agents.execution.react_executor.tool_processing import ToolProcessingMixin
from minder.core.agents.execution.react_executor.session_persistence import SessionPersistenceMixin
from minder.core.agents.execution.react_executor.iteration import IterationMixin
...
def _session_debug() -> "SessionDebugLogger":
    ...
    from minder.core.debug import get_debug_logger
...
if TYPE_CHECKING:
    ...
    from minder.core.context_engineering.history import SessionManager
    from minder.models.config import Config
    from minder.core.agents.execution.llm_caller import LLMCaller
    from minder.core.agents.execution.tool_executor import ToolExecutor
    from minder.core.runtime.approval import ApprovalManager
    from minder.core.context_engineering.history import UndoManager
    from minder.core.debug.session_debug_logger import SessionDebugLogger
...
class ReactExecutor(ThinkingMixin, ToolProcessingMixin, SessionPersistenceMixin, IterationMixin):
    ...
    def request_interrupt(self) -> bool:
        ...
        """
        try:
            from minder.core.agents.display.debug_logger import debug_log
        except ImportError:
    ...
    def execute(
        ...
        from minder.core.context_engineering.validated_message_list import ValidatedMessageList
        ...
        if self._snapshot_manager is None:
            try:
                from minder.core.context_engineering.history.snapshot import SnapshotManager
    ...
    def _maybe_compact(self, ctx: IterationContext) -> None:
        ...
        if self._compactor is None:
            from minder.core.context_engineering.compaction import ContextCompactor
        ...
        from minder.core.context_engineering.compaction import OptimizationLevel
