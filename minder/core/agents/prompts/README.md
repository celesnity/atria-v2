# Minder Prompt Architecture

This directory contains the modular prompt system for Minder agents. The architecture is inspired by Claude Code's composable prompt design.
...
# Create composer
templates_dir = Path("minder/core/agents/prompts/templates")
...
```python
grep "MY_VAR" minder/core/agents/prompts/variables.py
```
