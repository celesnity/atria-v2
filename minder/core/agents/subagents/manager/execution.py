...
if TYPE_CHECKING:
    ...
    from minder.core.agents.subagents.manager.manager import SubAgentDeps
    from minder.core.agents.subagents.specs import CompiledSubAgent
...
class ExecutionMixin:
    ...
    def execute_subagent(
        ...
        if docker_handler is not None:
            ...
            from minder.core.docker.tool_handler import DockerToolRegistry
        ...
        if ui_callback is not None:
            from minder.core.agents.callbacks.nested_callback import NestedUICallback
    ...
    def _parse_ask_user_questions(self, questions_data: list) -> list:
        ...
        """
        from minder.core.context_engineering.tools.implementations.ask_user_tool import (
            Question,
            QuestionOption,
        )
