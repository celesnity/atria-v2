...
from minder.core.agents.subagents.specs import CompiledSubAgent, SubAgentSpec

if TYPE_CHECKING:
    from minder.core.agents.subagents.manager.manager import AgentConfig
...
class RegistrationMixin:
    ...
    def register_defaults(self) -> None:
        ...
        from minder.core.agents.subagents.agents import ALL_SUBAGENTS
    ...
    def get_agent_configs(self) -> list[AgentConfig]:
        ...
        """
        from minder.core.agents.subagents.agents import ALL_SUBAGENTS
        from minder.core.agents.subagents.manager.manager import AgentConfig, AgentSource
    ...
    def register_custom_agents(self, custom_agents: list[dict]) -> None:
        ...
        - ~/.minder/agents.json or <project>/.minder/agents.json (JSON format)
        - ~/.minder/agents/*.md or <project>/.minder/agents/*.md (Claude Code markdown format)
