...
from minder.models.operation import EditResult, Operation
from minder.core.context_engineering.tools.implementations.base import BaseTool
from minder.core.context_engineering.tools.implementations.diff_preview import DiffPreview, Diff
from minder.core.context_engineering.tools.implementations.edit_tool.replacers import (
    _REPLACER_CHAIN,
    _normalize_line_endings,
)

if TYPE_CHECKING:
    from minder.core.runtime.task_monitor import TaskMonitor
