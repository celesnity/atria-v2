...
- File-based output storage (/tmp/minder/<path>/tasks/<id>.output)
...
class BackgroundTaskManager:
    ...
    def _get_output_dir(self) -> Path:
        ...
        Returns:
            Path like /tmp/minder/-Users-anlnm-codes-test-opencli/tasks/
        """
        ...
        return Path(tempfile.gettempdir()) / "minder" / safe_path / "tasks"
