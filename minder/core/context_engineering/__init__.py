"""Context Engineering subsystem for Minder.
...
from minder.core.context_engineering.tools import ToolRegistry, ToolExecutionContext
...
from minder.core.context_engineering.memory.playbook import Playbook
