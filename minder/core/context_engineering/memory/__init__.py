"""Long-term memory and learning for Minder (ACE Pattern).
...
from minder.core.context_engineering.memory.playbook import Playbook, Bullet
from minder.core.context_engineering.memory.delta import DeltaOperation, DeltaBatch
from minder.core.context_engineering.memory.roles import (
    AgentResponse,
    Reflector,
    Curator,
    ReflectorOutput,
...
from minder.core.context_engineering.memory.playbook import SessionPlaybook, Strategy
