...
class SnapshotManager:
    ...
    def __init__(self, project_dir: Path):
        ...
        self._snapshot_dir = minder_dir() / "data" / "snapshot" / self._project_id
    ...
    def _ensure_initialized(self) -> bool:
        ...
        try:
            ...
            if not git_dir.exists():
                ...
                self._git("config", "user.name", "minder-snapshot")
                self._git("config", "user.email", "snapshot@minder.local")
