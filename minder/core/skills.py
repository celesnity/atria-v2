...
- ~/.minder/skills/ (user global)
- <project>/.minder/skills/ (project local, takes priority)
...
class SkillLoader:
    ...
    def discover_skills(self) -> list[SkillMetadata]:
        ...
        # ``.minder/skills/`` entries with the same name still win, because
        ...
        try:
            ...
            for module in get_registry().all():
                ...
                # ``.minder/skills/`` entries with the same name win (set above).
