...
from minder.core.auth.keycloak.services import KeycloakServices
...
from minder.models.message import ChatMessage
...
class WebState:
    ...
    async def _persist_pending(
        ...
        try:
            ...
            from minder.db.repositories.pending_review_repo import PendingReviewRepository
