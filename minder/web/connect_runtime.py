...
(enable/disable). The agent bridge runs the full Minder agent for an inbound message
...
from minder.core.channels.connect_store import Connection, load_connect_config
from minder.core.channels.telegram import TelegramAdapter
from minder.core.paths import get_paths
from minder.core.runtime.approval.constants import AutonomyLevel
from minder.web.logging_config import logger
from minder.web.state import get_state

if TYPE_CHECKING:
    from minder.core.channels.router import MessageRouter
...
class ConnectManager:
    ...
    def _ensure_router(self) -> "MessageRouter":
        ...
        # session_manager, whose import chain reaches back into minder.web.
        from minder.core.channels.router import MessageRouter
