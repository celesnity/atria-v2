...
if TYPE_CHECKING:
    from minder.core.context_engineering.memory import Playbook
...
class Session(BaseModel):
    ...
    def add_message(self, message: ChatMessage) -> bool:
        ...
        """
        from minder.models.message_validator import validate_message
    ...
    def to_api_messages(self, window_size: Optional[int] = None) -> list[dict[str, str]]:
        ...
        from minder.core.context_engineering.message_pair_validator import (
