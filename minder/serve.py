"""Web server entry point — starts the Minder FastAPI server directly."""
...
def main() -> None:
    ...
    from minder.core.context_engineering.history.session_manager import PgSessionManager
    ...
    from minder.core.auth.pg_user_store import PgUserStore
    from minder.web import find_static_directory, start_server
    from minder.web.port_utils import find_available_port
    ...
    print(f"Minder web UI running at http://{args.host}:{backend_port}")
