...
export function StatusBar() {
  ...
  const pillBase = 'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[50%] border text-xs font-medium cursor-pointer transition-colors select-none hover:scale-105 active:scale-[0.98] whitespace-nowrap';
