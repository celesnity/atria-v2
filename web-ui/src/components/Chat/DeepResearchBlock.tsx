    ...
    <div className="p-4 space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex gap-2 items-end">
          ...
          >
            {pending === 'modify' ? (
              <span className="inline-block w-3.5 h-3.5 border-2 border-text-400 border-t-transparent rounded-[50%] animate-spin" />
            ) : (
        ...
        >
          {pending === 'regenerate' ? (
            <span className="flex items-center gap-1.5">
              <span className="inline-block w-2.5 h-2.5 border-2 border-text-400 border-t-transparent rounded-[50%] animate-spin" />
              Regenerating…
            </span>
          ) : 'Regenerate'}
        </button>
        ...
        >
          {pending === 'accept' ? (
            <span className="flex items-center justify-center gap-1.5">
              <span className="inline-block w-2.5 h-2.5 border-2 border-bg-000/60 border-t-transparent rounded-[50%] animate-spin" />
              Starting…
            </span>
          ) : (
    ...
    <div className="bg-bg-000 border border-border-300/15 rounded-lg overflow-hidden">
      ...
      {dr_active_section && dr_status === 'running' && (
        <div className="px-4 py-2 border-b border-border-300/10 flex items-center gap-2">
          <span className="inline-block w-1.5 h-1.5 rounded-[50%] bg-amber-400 animate-pulse" />
