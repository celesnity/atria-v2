...
export function TopBar() {
  ...
  const pillBase =
    "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[50%] border text-xs font-medium cursor-pointer transition-colors select-none hover-scale-pill";
  const iconBtn =
      ...
      <div className="flex items-center gap-4 flex-shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <span aria-hidden className="relative grid h-6 w-6 place-items-center">
            <span className="absolute inset-0 rounded-[50%] bg-gradient-brand opacity-90" />
            <span className="absolute inset-[3px] rounded-[50%] bg-canvas" />
            <span className="absolute right-[3px] top-[3px] h-1.5 w-1.5 rounded-[50%] bg-gradient-brand" />
          </span>
      ...
      {status && (
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          >
            <span
              aria-hidden="true"
              className={`w-1.5 h-1.5 rounded-[50%] ${isConnected ? "bg-semantic-success" : "bg-ink/30"}`}
            />
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        {me && (
          <div className="relative ml-0.5" ref={menuRef}>
            ...
            >
              <span
                className="w-6 h-6 rounded-[50%] bg-ink text-inverse-ink text-[11px] font-[600] flex items-center justify-center"
                aria-hidden
              >
                {initial}
              </span>
