          ...
          >
            ...
            {active && (
              <motion.span
                ...
                className="absolute inset-x-0 -bottom-0.5 h-0.5 rounded-[50%] bg-ink"
                transition={
                  reduce
                    ? { duration: 0 }
            ...
            {showBadge && (
              <span
                className="ml-0.5 inline-flex items-center gap-1 pl-1.5 pr-1.5 h-4 rounded-[50%] bg-amber-400/15 text-amber-500 text-[10px] font-mono font-[600] leading-none"
                aria-hidden="true"
              >
                <span className="w-1.5 h-1.5 rounded-[50%] bg-amber-400 animate-pulse-dot" />
                {runningJobs}
              </span>
            )}
          </Link>
